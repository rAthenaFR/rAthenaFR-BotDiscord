...
> **Bridge en jeu**
>
> `/gmmsg` n’utilise pas SQL.
> Sans bridge map-server configuré, la commande répond que le bridge in-game n’est pas configuré.
> Le mode `test` reste utile pour valider les permissions et les logs staff.
